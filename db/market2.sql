...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Sep 2022 pada 18.24
...
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `transaksi_to`
  MODIFY `id_transaksi_to` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
