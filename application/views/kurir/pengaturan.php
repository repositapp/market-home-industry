...
<div id="costumer" class="map-product-section px-15">
   <div class="product-inline">
      <a class="cart-img">
         <img src="<?= base_url(); ?>assets/upload/<?= $user['foto_kurir']; ?>" class="img-circle" alt="">
      </a>
      <div class="cart-content">
         <a>
            <h4 class="font-16"><?= $user['nm_kurir']; ?></h4>
         </a>
         <h5 class="content-color"><i class="iconly-Call icli"></i> <?= $user['telp_kurir']; ?></h5>
         <div class="price">
