            ...
            <div class="row justify-content-center">
               <div class="col-sm-6 col-xl-4 ">
                  <div class="misc-box">
                        ...
                        <fieldset style="padding-bottom: 0px;">
                           <div class="form-group">
                              ...
                              <div class="group-icon">
                                 <input id="exampleuser1" name="username" type="text" placeholder="Username" class="form-control" value="<?= set_value('username'); ?>" autocomplete="off" autofocus onkeyup="this.value = this.value.toLowerCase()">
                     ...
                     <a href="<?= base_url(); ?>auth/register_user" class="btn btn-block btn-success btn-rounded box-shadow">Registrasi Sekarang</a>
                  </div>
               </div>
            </div>
         </div>
