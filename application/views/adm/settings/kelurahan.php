                  ...
                  foreach ($data_kelurahan as $kelurahan) : ?>
                     <tr>
                        ...
                        <td class="text-center">
                           ...
                           <a href="<?= base_url(); ?>wilayah/hapus_kelurahan/<?= $kelurahan['id_kelurahan']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin ingin menghapus data ini?');" data-toggle="tooltip" data-placement="bottom" title="Hapus Data"><i class="fa fa-trash"></i></a>
                        </td>
                     </tr>
                     ...
                     <div id="ubahData<?= $no; ?>" class="modal fade bs-example-modal-default" tabindex="-1" role="dialog" aria-labelledby="myDefaultModalLabel">
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              <form method="post" action="<?= base_url('wilayah/kelurahan'); ?>" enctype="multipart/form-data">
                                 ...
                                 <div class="modal-body">
                                    ...
                                    <input type="hidden" id="id_kelurahan" name="id_kelurahan" value="<?= $kelurahan['id_kelurahan']; ?>">

                                    <div class="form-group row">
                                       <label for="label" class="col-sm-3 col-form-label">Kecamatan</label>
                                       <div class="col-sm-9">
                                          <select id="id_kecamatan" name="id_kecamatan" class="form-control m-b" required>
                                             <option selected="selected" disabled>-Pilih Kecamatan-</option>
                                             <?php foreach ($data_kecamatan as $kecamatan) : ?>
                                                <option <?php if ($kecamatan['id_kecamatan'] == $kelurahan['id_kecamatan']) {
                                                            echo 'selected';
                                                         } ?> value="<?= $kecamatan['id_kecamatan']; ?>"><?= $kecamatan['nm_kecamatan']; ?></option>
                                             <?php endforeach; ?>
                                          </select>
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                       <label for="label" class="col-sm-3 col-form-label">Kelurahan</label>
                                       <div class="col-sm-9">
                                          <input type="text" id="nm_kelurahan" name="nm_kelurahan" class="form-control" autocomplete="off" value="<?= $kelurahan['nm_kelurahan']; ?>" required>
                                       </div>
                                    </div>
                                 </div>
            ...
            <form method="post" action="<?= base_url('wilayah/kelurahan'); ?>" enctype="multipart/form-data">
               ...
               <div class="modal-body">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-sm-9">
                        <select id="id_kecamatan" name="id_kecamatan" class="form-control m-b" required>
                           <option selected="selected" disabled>-Pilih Kecamatan-</option>
                           <?php foreach ($data_kecamatan as $kecamatan) : ?>
                              <option value="<?= $kecamatan['id_kecamatan']; ?>"><?= $kecamatan['nm_kecamatan']; ?></option>
                           <?php endforeach; ?>
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="form-group row">
                     <label for="label" class="col-sm-3 col-form-label">Kelurahan</label>
                     <div class="col-sm-9">
                        <input type="text" id="nm_kelurahan" name="nm_kelurahan" class="form-control" autocomplete="off" required>
                     </div>
                  </div>
               </div>
               <div class="modal-footer">
